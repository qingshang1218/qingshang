<template>
	<view class="center">
		...
		<view class="center_box_bg">
			<view class="profily">
				<view class="base">
					<image :src="avatarUrl" mode="" id="avatatUrl"></image>
					<text>{{nickname}}</text>
					<button v-if="nickname==='昵称'" type="default" open-type="getUserInfo" @getuserinfo="getUserInfo" withCredentails='true' id="getUserInfo">使用微信登录</button>
