	...
	<view>
		<view id="head">
			<view class="head-lift">
				<image src="../../static/zhinan/位置.png" mode="" style="width: 35upx; height: 45upx;"></image>
				<text>郑州</text>
			</view>
			
			<view class="head-right">
				<image src="../../static/zhinan/搜索.png" style="width: 35upx; height: 35upx;"></image>
			</view>
		...
		<!-- </swiper> -->
		<view>
			<image src="../../static/zhinan/banner图.png"></image>
		</view>
		...
		<view>
			...
			<view class="tip-text">
				<view class="sousuo-img-view" @click="startRecord()">
					<image src="../../static/zhinan/语音识别.png" class="sousuo-img"></image>
					<view >
				...
				<view class="sousuo-img-view">
					<image src="../../static/zhinan/扫描识别.png"  class="sousuo-img"></image>
					<view>
						<text  style="color:#FF9224 ;">扫描识别</text>
					</view>
				</view>
				<view class="sousuo-img-view"  @click="imgShiBie()">
					<image src="../../static/zhinan/图片识别.png"   class="sousuo-img"></image>
					<view>
		...
		<view class="xiaochangshi-view">
			...
			<image src="../../static/zhinan/轮播图.png" style="margin-top: 20upx; width: 100%;"></image>
		</view>
		...
		<view>
			<view class="main-classify">
				<view class="view-img" @click="switchTabToClassify(0)">
					<image src="../../static/zhinan/干垃圾.png" mode="" class="classify-img"></image>
					<view class="text-view"><text style="font-size: 20px; color: #D200D2;">干垃圾</text></view>
					
				</view>
				<view class="view-img" @click="switchTabToClassify(1)">
					<image src="../../static/zhinan/湿垃圾.png" mode="" class="classify-img"></image>
			...
			<view class="main-classify">
				<view class="view-img" @click="switchTabToClassify(3)">
					<image src="../../static/zhinan/可回收物.png" mode="" class="classify-img"></image>
				...
				<view class="view-img" @click="switchTabToClassify(2)">
					<image src="../../static/zhinan/有害垃圾.png" mode="" class="classify-img"></image>
